...
namespace SolarWatchTest
{
    public class WeatherProviderTest : WebApplicationFactory<Program>
    {
        ...
        public void Setup()
        {
            string connectionString = "Server=localhost,1433;Database=SolarWatch;User Id=sa;Password=yourStrong(!)Password;Encrypt=True;TrustServerCertificate=True;";
            ...
            AuthRequest authRequest = new AuthRequest("nagybence0601@gmail.com", "asdasd");
        ...
        public async Task GetSunriseSunset_ValidRequest_ReturnsSunriseSunset()
        {
            ...
            // Act
            var response = await _client.GetAsync($"/Solar/api/solar?cityName={cityName}&date={date:yyyy-MM-dd}");
